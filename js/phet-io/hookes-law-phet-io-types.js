...
window.phet.preloads.phetio.phetioTypes = assert &&
  {
    ...
    "EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)": {
      "documentation": "Possible values: BAR_GRAPH,ENERGY_PLOT,FORCE_PLOT.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)"
    },
    "EnumerationIO(SERIES|PARALLEL)": {
      "documentation": "Possible values: SERIES,PARALLEL.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(SERIES|PARALLEL)"
    },
    ...
    "FunctionIO(EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT),NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT), NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)",
        "NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT),NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>)=>VoidIO"
    },
    "FunctionIO(EnumerationIO(SERIES|PARALLEL),NullableIO<EnumerationIO(SERIES|PARALLEL)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(SERIES|PARALLEL), NullableIO<EnumerationIO(SERIES|PARALLEL)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(SERIES|PARALLEL)",
        "NullableIO<EnumerationIO(SERIES|PARALLEL)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(SERIES|PARALLEL),NullableIO<EnumerationIO(SERIES|PARALLEL)>)=>VoidIO"
    },
    ...
    "NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>"
    },
    "NullableIO<EnumerationIO(SERIES|PARALLEL)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(SERIES|PARALLEL)>"
    },
    "NullableIO<EnumerationIO(TOTAL|COMPONENTS)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "PropertyIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(BAR_GRAPH|ENERGY_PLOT|FORCE_PLOT)>"
    },
    "PropertyIO<EnumerationIO(SERIES|PARALLEL)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(SERIES|PARALLEL)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(SERIES|PARALLEL)>"
    },
