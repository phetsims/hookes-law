...
type EnergyPlotOptions = SelfOptions & NodeTranslationOptions & PickRequired<XYPointPlotOptions, 'visibleProperty'>;
...
export default class EnergyPlot extends XYPointPlot {
  ...
  public constructor( spring: Spring,
    ...
    const options = optionize<EnergyPlotOptions, SelfOptions, XYPointPlotOptions>()( {
      ...
      yStringProperty: HookesLawStrings.potentialEnergyStringProperty,
      yUnitsStringProperty: HookesLawStrings.joulesStringProperty,
