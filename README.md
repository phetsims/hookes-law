...
(4) Open in the browser: `http://localhost/hookes-law/hookes-law_en.html`
...
(3) Open in the
browser: `http://localhost/hookes-law/build/adapted-from-phet/hookes-law_en_adapted-from-phet.html`
